...
package com.clownfish7.multidatasource.datasource.aspect;
...
public class DataSourceAspect {
    ...
    @Pointcut("@annotation(com.clownfish7.multidatasource.datasource.annotation.DataSource) " +
            "|| @within(com.clownfish7.multidatasource.datasource.annotation.DataSource)")
